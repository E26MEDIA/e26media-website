...
export function SiteHeader() {
  ...
  return (
    <header className="glass sticky top-0 z-50 border-b border-zinc-200/70 dark:border-zinc-800">
      ...
      <div
        className={cn(
          "fixed right-0 top-0 z-50 h-full w-[min(100%,20rem)] border-l border-zinc-200 bg-white p-6 shadow-xl transition dark:border-zinc-800 dark:bg-zinc-950 lg:hidden",
